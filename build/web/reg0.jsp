...
<html>
     <head>
          ...
          <title>BOOKBUG | Registration</title>
               ...
               <div class="content-wrapper" id="">
                    ...
                    <div class="grid">
                         <div class="grid-col-sm-12 grid-col-md-6" data-animation="fadeInLeft">
                              ...
                              <img class="grid-col-sm-12" src="img/welcome.png" alt="">
                              <p id="link" >Existing User? <a href="login.html">Click Here </a></p>
                         </div>
                         <div class="grid-col-sm-12 grid-col-md-6" data-animation="fadeInRight">
                              <h2 class="section-title">Join Us Today</h2>
                              <div class="signup-content">
                    <form id="signup-form" action="reg" method="post" class="signup-form">



                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email" class="form-input" name="EmailId" id="EmailId" placeholder="something@domain.com" required/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-input" name="re_password" id="re_password" placeholder=""/>
                            </div>



                        <div class="form-text">
                            <a href="#" class="add-info-link"><i class="zmdi zmdi-chevron-right"></i>Personal info</a>
                            <div class="add_info">
                              <div class="form-group">
                              ...
                              <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-input" name="MobileNumber" id="MobileNumber" />
                                </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <label for="address">Address:</label>
                                   <textarea type="text" name="Address" class="form-input" id="Address"></textarea>
                              </div>
                              <div class="form-group">

                                  <label for="pin">Pincode:</label>
                                   <input type="number" class="form-input" id="Pincode" name="Pincode">
                              </div>


                                <div class="form-group">
                                    <input type="submit" name="submit" id="submit" class="form-submit" value="Create My Account"/>
                                </div>
                            </div>
                        </div>
