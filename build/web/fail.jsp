  ...
  <body>
    ...
    <section class="error">
      <div data-aos="zoom-out-up" class="container2">
        ...
        <h5>Some required information is missing or incomplete. Please correct your entries and try again.</h5>
        <h6 style="padding-bottom: 20px;"><a href="login.jsp">Click Here</a> to return back</h6>
