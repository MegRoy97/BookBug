               ...
               <div class="product-container" id="">
                 <div class="grid-col-sm-12" data-animation="fadeInLeft" style="overflow-y:  hidden;">
                   <ul class="sc-nav">
                    ...
                    <li><a class="active" href="horror.jsp">Horror</a></li>
                    <li><a href="bio.jsp">biography</a></li>
                    ...
                    <div class="xop-section">
                      <ul class="xop-grid">
                          ...
                          <div class="xop-box">
                            <%
                            try{
                              System.out.println("Here in horror");
                                      ...
                                      String sql="select * from products where ProductCategory like ?";
                                          ...
                                          ps.setString(1,"Computer Programming%");
//                                          System.out.println("ps in horror:"+ps);
                                          ...
                                          while(rs.next()){
                                              ...
                                              System.out.println(ProductId+" "+ ProductPrice+" "+ ProductImage+" "+ ProductName);
